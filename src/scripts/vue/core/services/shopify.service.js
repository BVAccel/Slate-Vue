...
export class ShopifyService {
  ...
  getSectionData(handle) {
    return this.getThemeSettingsData().then((res) => {
      console.log(res.sections[handle]);
